...
## Purpose
Defines the GitHub Actions CI and release pipeline: quality gates, coverage thresholds, workflow linting, local pre-commit parity, security best practices, and tagged release builds.
